...
//Кроме этого, неавторизованный пользователь не может напрямую попасть на маршрут /reset-password. Подумайте, как защитить маршрут /reset-password от пользователей, которые не заходили на маршрут /forgot-password ранее и не вводили почту для восстановления пароля.
